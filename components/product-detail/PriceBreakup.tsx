...
export default function PriceBreakup({ priceBreakup }: PriceBreakupProps) {
  return (
    <div className="mb-8 sm:mb-10 md:mb-12 overflow-hidden">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1.5 sm:mb-2">Price Breakup</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-2 space-y-3 sm:space-y-4">
          ...
          <div className="flex justify-between py-3 sm:py-4 border-t-2 border-gray-300">
            <span className="text-base sm:text-lg font-bold text-gray-900">Total</span>
            <span className="text-base sm:text-lg font-bold text-gray-900">₹ {priceBreakup.total.toLocaleString('en-IN')}</span>
          </div>
        </div>

        {/* Pricing Notes */}
        <div className="bg-[#FFF8E7] p-4 sm:p-5 md:p-6 rounded-lg">
          <h3 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Pricing Notes</h3>
